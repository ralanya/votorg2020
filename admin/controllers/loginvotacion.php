			...
			if (isset($row_persona)) {
				...
				if ($condicion_apertura==1) {
					if ($fecha_actual>=$fecha_star and $fecha_actual<=$fecha_end) {
						$_SESSION['idpersona_v']=$row_persona->idpersona;
						$_SESSION['nombre_v']=$row_persona->nombre;
						$_SESSION['apellidos_v']=$row_persona->apellidos;
						$_SESSION['dni_v']=$row_persona->dni;
						echo $rspta=6;
